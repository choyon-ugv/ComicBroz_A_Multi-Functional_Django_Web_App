"""
Django settings for choyon007 project.
...
SECRET_KEY = 'django-insecure-6h%v*-kilkih5(qb22e0u1=s5zf=f2%xlcm3^+b$sd4q+3gw^+'
...
WSGI_APPLICATION = 'choyon007.wsgi.application'
